...
<script type="text/javascript">
	...
	var userInfoMgr = {
		init: function(){
			$.ajax({
				type:'post',//请求方式
				url:'${ctx}/sys/user/getUserInfoById',
		...
		saveSelfUserInfo : function(){
			...
			$.ajax({
					type:'post',//请求方式
					url:'${ctx}/sys/user/saveSelfUserInfo',
...
<body>
	<ul class="nav nav-tabs">
		...
		<li><a href="${ctx}/sys/user/gotoChangePwd">修改密码</a></li>
	</ul><br/>
	<form id="userInfoForm" class="form-horizontal" action="#" method="post">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input id="loginName" name="loginName" class="required" type="text"  maxlength="50"/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<label class="lbl"><div id = "roleName"></div></label>
			</div>
		</div>
