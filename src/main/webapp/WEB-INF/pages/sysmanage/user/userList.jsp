...
var setting = {
	...
	$(document).ready(function(){
	     $.get("${ctx}/sys/dept/getAllDeptList", function (zNodes) {
	        // 初始化树结构
				...
				success:function(data){//与服务器交互成功调用的回调函数
					...
					if(userList!=null&&userList.length>0){				
							...
							for(var i=0;i<userList.length;i++){
								...
								htmlTable = htmlTable+"</td>";	
								htmlTable = htmlTable+"<td>";
	 			    			var editButton ="<a href='${ctx}/sys/user/gotoUserEdit?editFlag=2&&userId="+userList[i].userId+"'>修改</a>";
								var delButton = "<a href='javascript:userMgr.delUser("+userList[i].userId+")'>删除</a>";
								var addButton = "<a href='${ctx}/sys/user/gotoUserEdit.action?editFlag=1'>添加</a>";
...
<ul class="nav nav-tabs">
    ...
    <li><a href="${ctx}/sys/user/gotoUserEdit?editFlag=1">用户添加</a></li>
