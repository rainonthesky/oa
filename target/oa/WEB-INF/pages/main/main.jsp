...
<div id="main" style="width: auto;">
			...
			<ul id="userControl" class="nav pull-right">
				...
				<li id="userInfo" class="dropdown">
					...
					<ul class="dropdown-menu">
						<li><a href="${ctx}/sys/user/gotoUserInfo" target="mainFrame"><i class="icon-user"></i>&nbsp; 个人信息</a></li>
						<li><a href="${ctx}/sys/user/gotoChangePwd" target="mainFrame"><i class="icon-lock"></i>&nbsp;  修改密码</a></li>
					</ul>
				</li>
	...
	<div class="container-fluid">
		...
		<div id="footer" class="row-fluid">
			Copyright © 2015-2025 <a href="http://www.tanzhouedu.com/" target="_blank">OA管理系统</a> - Powered By tz V1.0
		</div>
	</div>
</div>
<script type="text/javascript">
