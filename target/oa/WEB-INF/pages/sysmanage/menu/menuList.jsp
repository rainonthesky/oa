...
<body>
	<ul class="nav nav-tabs">
		...
		<li><a href="${ctx}/sys/menu/gotoMenuEdit?editFlag=1">菜单添加</a></li>
	</ul>
	 
	<form id="menuListForm" method="post" action="${ctx}/sys/menu/gotoMenuList.action">
				...
				<c:forEach items="${menuList}" var="menu">
					<tr id="${menu.id}" pId="${menu.parentId}">
						<td nowrap>
							...
							<a href="${ctx}/sys/menu/gotoMenuEdit?editFlag=2&menuId=${menu.id}">${menu.name}</a></td>
						...
						<td nowrap>
							<a href="${ctx}/sys/menu/gotoMenuEdit?editFlag=2&menuId=${menu.id}">修改</a>
							<a href="javascript:menuMgr.delMenu(${menu.id})">删除</a>
							<a href="${ctx}/sys/menu/gotoMenuEdit?editFlag=1&parentId=${menu.id}">添加下级菜单</a>
						</td>
					</tr>
				</c:forEach>
