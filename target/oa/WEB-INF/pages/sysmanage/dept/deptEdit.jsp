...
var setting = {
	...
	$(document).ready(function(){	
		 ...
		 var deptId  = $("#id").val(); 
	     $.get("${ctx}/sys/dept/getParentDeptTreeData?deptId="+deptId, function (zNodes) {
	        // 初始化树结构
...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/sys/dept/gotoDeptList.action">部门列表</a></li>
		<li class="active">
	...
	<form id="deptEditForm" class="form-horizontal" action="#" method="post">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input id="address" name="address" class="input-small" type="text" value="${dept.address}" maxlength="50"/>
			</div>
		</div>
		<div class="control-group">
