    ...
    var processDeployMgr = {    		
   		delprocessDeploy:function(deploymentId){	
  	 		if(confirm("您确定要删除此流程部署吗?")){  	 			 
  		 		  $.ajax({
  						type:'post',//请求方式
  						url:'${ctx}/sys/processDeploy/delProcessDeploy',
...
<body>
	<ul class="nav nav-tabs">
		...
		<li><a href="${ctx}/sys/processDeploy/gotoProcessDeployAdd">流程部署</a></li>
	</ul>

	<form id="processDeployListForm" method="post" action="${ctx}/sys/processDeploy/gotoProcessDeployList">
