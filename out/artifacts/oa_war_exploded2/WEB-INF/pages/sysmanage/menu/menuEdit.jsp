...
<meta name="renderer" content="webkit">
	...
	var setting = {
		...
		$(document).ready(function(){
			...
			var menuId = $("#id").val();
			$.get("${ctx}/sys/menu/getParentMenuTreeData.action?menuId="+menuId,
					function(zNodes){
						//初始化数结构
...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/sys/menu/gotoMenuList">菜单列表</a></li>
	...
	<form id="menuEditForm" class="form-horizontal" action="#" method="post">
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<%--<a id="iconButton" href="/sys/menu/iconSelect.jsp" class="btn">选择</a>&nbsp;&nbsp;--%>
