...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/sys/processDeploy/gotoProcessDeployList">流程部署列表</a></li>
		<li class="active"><a href="javascript:void(0);">流程部署</a></li>
	</ul><br/>
	<form id="processDeployAddForm" class="form-horizontal" 
				action="${ctx}/sys/processDeploy/addProcessDeploy" method="post" enctype="multipart/form-data">
